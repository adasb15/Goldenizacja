...
class PartyStaging(Base):
    ...
    Province: Mapped[str | None] = mapped_column(String(100), nullable=True)
    Country: Mapped[str | None] = mapped_column(String(100), nullable=True)
    Register_Status: Mapped[str | None] = mapped_column(String(100), nullable=True)
    ...
    Related_Persons_JSON: Mapped[str | None] = mapped_column(Text, nullable=True)
    Related_Parties_JSON: Mapped[str | None] = mapped_column(Text, nullable=True)
    ...
    Managing_LOU: Mapped[str | None] = mapped_column(String(50), nullable=True)
    Validation_Sources: Mapped[str | None] = mapped_column(String(100), nullable=True)
    Validation_Authority_ID: Mapped[str | None] = mapped_column(String(50), nullable=True)
    Validation_Authority_Entity_ID: Mapped[str | None] = mapped_column(String(100), nullable=True)
    Direct_Parent_LEI: Mapped[str | None] = mapped_column(String(20), nullable=True)
    Direct_Parent_Name: Mapped[str | None] = mapped_column(String(255), nullable=True)
    Direct_Parent_Relationship_Type: Mapped[str | None] = mapped_column(String(100), nullable=True)
    Direct_Parent_Relationship_Status: Mapped[str | None] = mapped_column(String(50), nullable=True)
    ...
    Ultimate_Parent_LEI: Mapped[str | None] = mapped_column(String(20), nullable=True)
    Ultimate_Parent_Name: Mapped[str | None] = mapped_column(String(255), nullable=True)
    Ultimate_Parent_Relationship_Type: Mapped[str | None] = mapped_column(String(100), nullable=True)
    Ultimate_Parent_Relationship_Status: Mapped[str | None] = mapped_column(String(50), nullable=True)
