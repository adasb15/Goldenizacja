...
class FileStorageService:
    def __init__(self) -> None:
        ...
        # Tworzymy katalog zapisu automatycznie, żeby endpoint dokumentów działał w świeżym środowisku
        self.base_path.mkdir(parents=True, exist_ok=True)

    def save_document(self, title: str, content: str) -> str:
        # Zamieniamy tytuł na bezpieczną nazwę, żeby dane z requestu nie trafiły wprost do ścieżki
